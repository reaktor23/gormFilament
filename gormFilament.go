package github.com/reaktor23/gormFilament
...
func CreateFilamentRGBRaw(name string, material string, r uint8, g uint8, b uint8, weight uint, slot uint) Filament {
...
func CreateFilamentRGB(name string, material string, color colors.RGBColor, weight uint, slot uint) Filament {
